...
TEST_FILES = {
    "nyt":     "E3_student_package/eval_prompts/nyt_test_eval.jsonl",
    "webnlg":  "E3_student_package/eval_prompts/webnlg_test_eval.jsonl",
    "conll04": "E3_student_package/eval_prompts/conll04_test_eval.jsonl",
}
...
parser.add_argument("--dataset", choices=["nyt", "webnlg", "conll04"], required=True)
...
logging.info("===== External inference started =====")
...
def main():
    ...
    logging.info("===== External inference finished =====")
